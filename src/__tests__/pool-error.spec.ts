...
describe('onPoolError — PostgresAdapter', () => {
    beforeEach(() => {
        ...
        mockPgPoolInstance.on.mockClear();
    });
    ...
    it('registers error listener on pool when onPoolError is provided', async () => {
        ...
        expect(mockPgPoolInstance.on).toHaveBeenCalledWith(
            'error',
            onPoolError,
        );
    });
...
describe('onPoolError — MysqlAdapter', () => {
    beforeEach(() => {
        ...
        mockMysqlPoolInstance.on.mockClear();
    });
    ...
    it('registers error listener on pool when onPoolError is provided', async () => {
        ...
        expect(mockMysqlPoolInstance.on).toHaveBeenCalledWith(
            'error',
            onPoolError,
        );
    });
...
describe('onPoolError — MssqlAdapter', () => {
    beforeEach(() => {
        ...
        mockMssqlPoolInstance.on.mockClear();
    });
    ...
    it('registers error listener on pool when onPoolError is provided', async () => {
        ...
        expect(mockMssqlPoolInstance.on).toHaveBeenCalledWith(
            'error',
            onPoolError,
        );
    });
